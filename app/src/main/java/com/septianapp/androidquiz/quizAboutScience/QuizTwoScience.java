...
public class QuizTwoScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_two_science);
    ...
    public void tampilDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent goNext = new Intent(QuizTwoScience.this, QuizThreeScience.class);
                startActivity(goNext);
                Toast.makeText(QuizTwoScience.this, "Congratulations", Toast.LENGTH_SHORT).show();
            }
        });

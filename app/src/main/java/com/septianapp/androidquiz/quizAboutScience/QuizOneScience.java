...
public class QuizOneScience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_one_science);
    ...
    public void tampilDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent goNext = new Intent(QuizOneScience.this, QuizTwoScience.class);
                startActivity(goNext);
                Toast.makeText(QuizOneScience.this, "Congratulations", Toast.LENGTH_SHORT).show();
            }
        });

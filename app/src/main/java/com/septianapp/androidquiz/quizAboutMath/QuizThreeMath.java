...
public class QuizThreeMath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_three_math);
    ...
    public void tampilDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent goNext = new Intent(QuizThreeMath.this, QuizFourMath.class);
                startActivity(goNext);
                Toast.makeText(QuizThreeMath.this, "Congratulations", Toast.LENGTH_SHORT).show();
            }
        });

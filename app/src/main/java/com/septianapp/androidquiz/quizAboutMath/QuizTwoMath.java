...
public class QuizTwoMath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_two_math);
    ...
    public void tampilDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent goNext = new Intent(QuizTwoMath.this, QuizThreeMath.class);
                startActivity(goNext);
                Toast.makeText(QuizTwoMath.this, "Congratulations", Toast.LENGTH_SHORT).show();
            }
        });

...
public class QuizOneMath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_one_math);
    ...
    public void tampilDialog() {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent goNext = new Intent(QuizOneMath.this, QuizTwoMath.class);
                startActivity(goNext);
                Toast.makeText(QuizOneMath.this, "Congratulations", Toast.LENGTH_SHORT).show();
            }
        });
